export default {
  ...
  exportDialog: {
    ...
    htmlEyebrow: 'HTML エクスポート設定',
    printableSubtitle: 'エクスポート前にページレイアウト、外観、ヘッダーとフッター、目次を調整します。',
    htmlSubtitle: 'エクスポート前にタイトル、外観、目次を調整します。',
    footerPrintable: '上記の設定を確認して、準備ができたらエクスポートします。',
    footerHtml: '上記の設定を確認して、準備ができたら HTML ファイルをエクスポートします。',
    tabs: {
      info: '情報',
      page: 'ページ',
      style: 'スタイル',
    ...
    export: 'エクスポート...',
    sections: {
      htmlDocument: 'HTML ドキュメント',
      htmlDocumentDescription: 'エクスポートする HTML ドキュメントのタイトルを設定します。',
      pageSetup: 'ページ設定',
      pageSetupDescription: 'PDF エクスポートで使用する用紙サイズと向きを選択します。',
      margins: '余白',
      marginsDescription: '印刷および PDF エクスポートに使用するページ余白を設定します。',
      width: '幅',
      height: '高さ',
      marginTop: '上余白',
      marginBottom: '下余白',
      ...
      marginRight: '右余白',
      typography: 'タイポグラフィ',
      typographyDescription: 'エクスポート内容に使用するフォントと組版設定を上書きします。',
      documentDetails: 'ドキュメント詳細',
      documentDetailsDescription: 'エクスポートに追加の構造情報を含めるかどうかを選択します。',
      theme: 'テーマ',
      header: 'ヘッダー',
      footer: 'フッター',
      footerDescription: 'フッターのレイアウトを選択し、表示テキストをカスタマイズします。',
      headerFooterStyle: 'ヘッダーとフッターのスタイル',
      headerFooterStyleDescription: '印刷時のヘッダーとフッター領域で使用するタイポグラフィをカスタマイズします。',
      toc: '目次',
      tocDescription: '目次タイトルと、目次に含める見出し範囲を制御します。'
    },
    option: {
      custom: 'カスタム',
      none: 'なし',
  ...
  preferences: {
    ...
    editor: {
      ...
      endOfLineDefault: 'デフォルト',
      endOfLineCRLF: 'キャリッジリターン＋ラインフィード (CRLF)',
      endOfLineLF: 'ラインフィード (LF)',
      trailingNewlineTrimAll: 'すべての末尾改行を削除',
      trailingNewlineEnsureOne: '末尾改行を1つだけにする',
      trailingNewlinePreserve: '原文書のスタイルを保持',
      trailingNewlineNone: '何もしない',
