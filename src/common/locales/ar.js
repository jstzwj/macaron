export default {
  ...
  preferences: {
    ...
    editor: {
      ...
      textDirectionLTR: 'من اليسار إلى اليمين',
      textDirectionRTL: 'من اليمين إلى اليسار',
      endOfLineDefault: 'افتراضي',
      endOfLineCRLF: 'عودة السطر وتغذية السطر (CRLF)',
      endOfLineLF: 'تغذية السطر (LF)',
      trailingNewlineTrimAll: 'حذف كل الأسطر الجديدة اللاحقة',
      trailingNewlineEnsureOne: 'ضمان وجود سطر جديد لاحق واحد بالضبط',
      trailingNewlinePreserve: 'الحفاظ على أسلوب المستند الأصلي',
      trailingNewlineNone: 'عدم القيام بأي شيء',
  ...
  menu: {
    ...
    view: {
      ...
      showTitleBar: 'إظهار شريط العنوان',
