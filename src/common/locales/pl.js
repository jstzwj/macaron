export default {
  ...
  preferences: {
    ...
    editor: {
      ...
      textDirectionLTR: 'Od lewej do prawej',
      textDirectionRTL: 'Od prawej do lewej',
      endOfLineDefault: 'Domyślny',
      endOfLineCRLF: 'Powrót karetki i nowy wiersz (CRLF)',
      endOfLineLF: 'Nowy wiersz (LF)',
      trailingNewlineTrimAll: 'Usuń wszystkie końcowe znaki nowej linii',
      trailingNewlineEnsureOne: 'Zapewnij dokładnie jeden końcowy znak nowej linii',
      trailingNewlinePreserve: 'Zachowaj styl oryginalnego dokumentu',
      trailingNewlineNone: 'Nie rób nic',
