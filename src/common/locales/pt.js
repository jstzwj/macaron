export default {
  ...
  preferences: {
    ...
    editor: {
      ...
      textDirectionLTR: 'Da esquerda para a direita',
      textDirectionRTL: 'Da direita para a esquerda',
      endOfLineDefault: 'Padrão',
      endOfLineCRLF: 'Retorno de carro e avanço de linha (CRLF)',
      endOfLineLF: 'Avanço de linha (LF)',
      trailingNewlineTrimAll: 'Remover todas as novas linhas finais',
      trailingNewlineEnsureOne: 'Garantir exatamente uma nova linha final',
      trailingNewlinePreserve: 'Preservar o estilo do documento original',
      trailingNewlineNone: 'Não fazer nada',
