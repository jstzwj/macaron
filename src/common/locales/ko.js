export default {
  ...
  preferences: {
    ...
    editor: {
      ...
      textDirectionLTR: '왼쪽에서 오른쪽',
      textDirectionRTL: '오른쪽에서 왼쪽',
      endOfLineDefault: '기본값',
      endOfLineCRLF: '캐리지 리턴 + 라인 피드 (CRLF)',
      endOfLineLF: '라인 피드 (LF)',
      trailingNewlineTrimAll: '모든 후행 줄바꿈 삭제',
      trailingNewlineEnsureOne: '후행 줄바꿈 하나만 유지',
      trailingNewlinePreserve: '원본 문서 스타일 유지',
      trailingNewlineNone: '아무것도 하지 않음',
