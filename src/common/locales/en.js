export default {
  ...
  exportDialog: {
    ...
    htmlEyebrow: 'HTML Export Settings',
    printableSubtitle: 'Adjust page layout, appearance, header and table of contents before exporting your document.',
    htmlSubtitle: 'Adjust title, appearance and table of contents before exporting your document.',
    footerPrintable: 'Review the settings above and export when ready.',
    footerHtml: 'Review the settings above and export your HTML file when ready.',
    tabs: {
      info: 'Info',
      page: 'Page',
      style: 'Style',
    ...
    sections: {
      ...
      htmlDocumentDescription: 'Configure the title used for the exported HTML document.',
      pageSetup: 'Page setup',
      pageSetupDescription: 'Choose paper size and orientation for the exported PDF.',
      margins: 'Margins',
      marginsDescription: 'Set the page margins applied during print and PDF export.',
      width: 'Width',
      height: 'Height',
      ...
      typographyDescription: 'Override the current editor font settings for exported output.',
      documentDetails: 'Document details',
      documentDetailsDescription: 'Choose whether extra structural information is included in the export.',
      theme: 'Theme',
      header: 'Header',
      footer: 'Footer',
      footerDescription: 'Choose the footer layout and customize visible text.',
      headerFooterStyle: 'Header & footer style',
      headerFooterStyleDescription: 'Customize typography used inside the print header and footer area.',
      toc: 'Table of contents',
      tocDescription: 'Control the generated title and the heading range included in the table of contents.'
    },
    option: {
      custom: 'Custom',
      none: 'None',
  ...
  preferences: {
    ...
    editor: {
      ...
      trailingNewlineNone: 'Do nothing',
