export default {
  ...
  exportDialog: {
    ...
    htmlEyebrow: 'Paramètres d\'export HTML',
    printableSubtitle: 'Ajustez la mise en page, l\'apparence, les en-têtes et pieds de page ainsi que la table des matières avant d\'exporter votre document.',
    htmlSubtitle: 'Ajustez le titre, l\'apparence et la table des matières avant d\'exporter votre document.',
    footerPrintable: 'Vérifiez les paramètres ci-dessus puis exportez lorsque tout est prêt.',
    footerHtml: 'Vérifiez les paramètres ci-dessus puis exportez votre fichier HTML lorsque tout est prêt.',
    tabs: {
      info: 'Infos',
      page: 'Page',
      style: 'Style',
    ...
    sections: {
      ...
      htmlDocumentDescription: 'Configure le titre du document HTML exporté.',
      pageSetup: 'Mise en page',
      pageSetupDescription: 'Choisissez la taille de papier et l\'orientation utilisées pour l\'export PDF.',
      margins: 'Marges',
      marginsDescription: 'Définissez les marges appliquées lors de l\'impression et de l\'export PDF.',
      width: 'Largeur',
      height: 'Hauteur',
      ...
      typographyDescription: 'Remplacez les paramètres de police et de composition utilisés pour l\'exportation.',
      documentDetails: 'Détails du document',
      documentDetailsDescription: 'Choisissez si des informations structurelles supplémentaires doivent être incluses dans l\'export.',
      theme: 'Thème',
      header: 'En-tête',
      footer: 'Pied de page',
      footerDescription: 'Choisissez la disposition du pied de page et personnalisez le texte affiché.',
      headerFooterStyle: 'Style de l\'en-tête et du pied de page',
      headerFooterStyleDescription: 'Personnalisez la typographie utilisée dans la zone d\'en-tête et de pied de page imprimée.',
      toc: 'Table des matières',
      tocDescription: 'Contrôlez le titre généré et la plage de titres incluse dans la table des matières.'
    },
    option: {
      custom: 'Personnalisé',
      none: 'Aucun',
  ...
  preferences: {
    ...
    editor: {
      ...
      textDirectionLTR: 'De gauche à droite',
      textDirectionRTL: 'De droite à gauche',
      endOfLineDefault: 'Par défaut',
      endOfLineCRLF: 'Retour chariot et saut de ligne (CRLF)',
      endOfLineLF: 'Saut de ligne (LF)',
      trailingNewlineTrimAll: 'Supprimer tous les sauts de ligne finaux',
      trailingNewlineEnsureOne: 'Assurer exactement un saut de ligne final',
      trailingNewlinePreserve: 'Conserver le style du document original',
      trailingNewlineNone: 'Ne rien faire',
