    ...
    >
      <div class="search-wrapper">
        <input
          ...
          :placeholder="$t('searchFolder.placeholder')"
          @keyup="search"
        >
        <div class="controls">
          <span
      ...
      <div class="search-message-section" v-if="showNoFolderOpenedMessage">
        <span>{{ $t('searchFolder.noFolderOpen') }}</span>
      </div>
      <div class="search-message-section" v-if="showNoResultFoundMessage">{{ $t('searchFolder.noResults') }}</div>
