<template>
  <div class="pref-markdown">
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('preferences.markdown.lists') }}</h6>
      </template>
      <template #children>
        <bool
          :description="$t('preferences.markdown.preferLooseList')"
          :bool="preferLooseListItem"
          :onChange="value => onSelectChange('preferLooseListItem', value)"
          more="https://spec.commonmark.org/0.29/#loose"
        ></bool>
        <cur-select
          :description="$t('preferences.markdown.bulletMarker')"
        ...
        ></cur-select>
        <cur-select
          :description="$t('preferences.markdown.orderDelimiter')"
        ...
        ></cur-select>
        <cur-select
          :description="$t('preferences.markdown.listIndentation')"
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('preferences.markdown.extensions') }}</h6>
      </template>
      <template #children>
        <cur-select
          :description="$t('preferences.markdown.frontmatter')"
        ...
        ></bool>
        <bool
          :description="$t('preferences.markdown.footnotes')"
          :notes="$t('preferences.markdown.footnotesNote')"
          :bool="footnote"
    ...
    <compound>
      ...
      <template #children>
        <bool
          :description="$t('preferences.markdown.enableHtml')"
          :bool="isHtmlEnabled"
          :onChange="value => onSelectChange('isHtmlEnabled', value)"
        ></bool>
        <bool
          :description="$t('preferences.markdown.gitlabCompat')"
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('preferences.markdown.diagrams') }}</h6>
      </template>
      <template #children>
        <cur-select
          :description="$t('preferences.markdown.sequenceTheme')"
          :value="sequenceTheme"
    ...
    <compound>
      <template #head>
        <h6 class="title">{{ $t('preferences.markdown.misc') }}</h6>
      </template>
      <template #children>
        <cur-select
          :description="$t('preferences.markdown.headingStyle')"
