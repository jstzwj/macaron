<template>
  <div class="pref-theme">
    ...
    <section v-show="false" class="import-themes ag-underdevelop">
      <div>
        <span>{{ $t('preferences.theme.openFolder') }}</span>
        <el-button size="small">{{ $t('preferences.theme.openFolderButton') }}</el-button>
      </div>

      <div>
        <span>{{ $t('preferences.theme.importTheme') }}</span>
        <el-button size="small">{{ $t('preferences.theme.importButton') }}</el-button>
      </div>
    </section>
  </div>
</template>
