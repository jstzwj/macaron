...
export default function (userPreference, i18n) {
  ...
  return {
    label: i18n.t('menu.theme.root'),
    id: 'themeMenu',
    submenu: [{
      label: i18n.t('menu.theme.light'),
      type: 'radio',
      id: 'light',
      checked: theme === 'light',
      ...
      label: i18n.t('menu.theme.graphite'),
      type: 'radio',
      id: 'graphite',
      ...
      label: i18n.t('menu.theme.materialDark'),
      type: 'radio',
      id: 'material-dark',
      ...
      label: i18n.t('menu.theme.oneDark'),
      type: 'radio',
      id: 'one-dark',
