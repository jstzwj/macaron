...
3. Config in Macaron Preferences window. click `CmdOrCtrl + ,` to open Macaron Preferences window.
...
5. Paste an image into Macaron and open you created repo to see the uploaded image.
