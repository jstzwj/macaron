...
Macaron can automatically copy your images into a specified directory or handle images from clipboard.
...
Note: The assets directory name must be a valid path name and Macaron need write access to the directory.
...
Macaron only saves images from clipboard into the specified local directory.
