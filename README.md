...
<div align="center">
  <sub>This Markdown editor that could. Built with :heart: by
    <a href="https://github.com/Jocs">Jocs</a>,
    <a href="https://github.com/marktext/marktext/graphs/contributors">
      MarkText contributors
    </a>
    and Macaron contributors.
  </sub>
</div>
...
If you wish to build Macaron yourself, please check out our [build instructions](docs/dev/BUILD.md).

- [User documentation](docs/README.md)
- [Developer documentation](docs/dev/README.md)

If you have any questions regarding Macaron, you are welcome to write an issue. When doing so please use the default format found when opening an issue. Of course, if you submit a PR directly, it will be greatly appreciated.

## Contribution

Macaron is in development, please make sure to read the [Contributing Guide](CONTRIBUTING.md) before making a pull request. Want to add some features to Macaron? Refer to open issues.
...
- @[Yasujizr](https://github.com/Yasujizr) for designing the MarkText logo
- All [MarkText contributors](https://github.com/marktext/marktext/graphs/contributors)
